...
de = {
    ...
    'Letterer Column:': 'Letterer Column:',
    'Cover Artist Column:': 'Cover Artist Column:',
    'Editor Column:': 'Editor Column:',
    'Story Arc Column:': 'Story Arc Column:',
    'Characters Column:': 'Characters Column:',
    ...
    "Only convert cbr to cbz": "Konvertiere cbr Dateien zu cbz Dateien",
    "Embed the calibre cover": "Bette das Calibre Cover ein",
    # main button (ui.py)
    'Import Comic Metadata': 'Importiere Comic Metadaten',
    'Imports the metadata from the comic to calibre': 'Importiere die Metadaten aus dem Comic',
    'Embed Comic Metadata': 'Bette Comic Metadaten ein',
